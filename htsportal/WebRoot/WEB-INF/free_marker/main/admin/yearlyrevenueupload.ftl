...
<head>
	<title>Yearly Revenue Upload: HT SYNDICATION</title>
								...
								<div class="box post">
									<div class="box-body post-body" style="min-height: 530px;">
										...
										<div style="display: block; padding:10px;">
											<div class="show-sub-title"><center>Yearly Revenue Upload</center></div>
									    	<div style="width: 700px;">
									    		<@s.form action="yearlyrevenueupload" theme="simple" enctype="multipart/form-data" method="post">
										    		<div class="formrow">
										    			<@s.actionerror/>
										    		</div>
										    		<div class="formrow">
