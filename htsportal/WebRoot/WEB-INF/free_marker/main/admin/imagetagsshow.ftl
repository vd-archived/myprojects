...
<head>
	<title>Show Image Categories: HT SYNDICATION</title>
							...
							<div class="layout-cell content">
								<div class="box post">
									<div class="box-body post-body" style="min-height: 580px;">
										<div align="center">
											<h1 class="postheader">Image Categories</h1>
											 <div class="box">
											  	<@s.actionerror/>
											  	<@s.form action="imagetagsdelete" theme="css_xhtml">
												  ...
												  <#if imagetagsVOs??>
													<#list imagetagsVOs as x>
													    ...
													    <td><a href="imagetagssave?id=${x.id}"><img src="${webroot}admin/images/edit.png" /></a></td>
													    </tr>
													</#list>
												  </#if>
												  <tr class="reportviewhead">
												  ...
												  <tr class="reportviewhead">
												  	<th colspan="5"><div align="center"><a href="imagetagssave" style="color:black;">Create Image Category</a>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" style="color:black;" onclick="javascript:submitForm('imagetagsdelete');">Disable Image Category</a></div></th>
												  </tr>
												</table>
												</@s.form>
											  </div>
